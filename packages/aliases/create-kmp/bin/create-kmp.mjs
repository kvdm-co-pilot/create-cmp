#!/usr/bin/env node
// create-kmp — thin official alias for create-cmp-cli.
//
...
try {
  ...
  process.stderr.write(
    "create-kmp: could not find its dependency create-cmp-cli.\n" +
...
if (!relBinPath) {
  process.stderr.write(
    "create-kmp: create-cmp-cli declares no bin entry.\n" +
...
if (result.error) {
  process.stderr.write(`create-kmp: failed to launch create-cmp-cli: ${result.error.message}\n`);
  process.exit(1);
}
if (result.signal) {
