...
[![Claude Code plugin](https://img.shields.io/badge/Claude%20Code-plugin-D97757.svg)](#the-claude-code-plugin-12-skills)
...
`/plugin install create-cmp` — [12 skills + the cmp-inspector MCP server](#the-claude-code-plugin-12-skills).
...
## The Claude Code plugin (12 skills)
